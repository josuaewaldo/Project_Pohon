        ...
        <div class="py-20 m-auto">
            ...
            <div class="flex justify-center mt-16">
                <div class="p-4 m-8 w-80 bg-white shadow-md rounded-xl">
                    ...
                    <a href="<?= base_url('User/formDonasi'); ?>" class="bg-[#527853] hover:bg-[#496b4a] text-white font-bold py-2 px-4 rounded">Donasi Sekarang</a>
                </div>
                <div class="p-4 m-8 w-80 bg-white shadow-md rounded-xl">
                    <picture class="rounded-lg block overflow-hidden">
        ...
        <div class="py-20 m-auto pb-40">
            ...
            <div class="flex justify-center mt-16">
                <div class="p-4 m-8 w-80 bg-white shadow-md rounded-xl">
                    ...
                    <button type="submit"
                        class="bg-[#527853] hover:bg-[#496b4a] text-white font-bold py-2 px-4 rounded">
                        Daftar Sekarang
                    </button>
                </div>
                <div class="p-4 m-8 w-80 bg-white shadow-md rounded-xl">
